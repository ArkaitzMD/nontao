...
#
# INTENTOS DE REALIZAR DIVERSAS OPERACIONES CON LAS FUNCIONES DE SPARK.SQL PARA MANEJO DE DATOS EN FORMATO JSON 
# FINALMENTE DECIDI TRATARLOS CON HIVE DIRECTAMENTE EN AMBARI DE HORTONWORKS
#
#
